...
public class ChatUtils {
    ...
    public static String method525(int i, boolean flag, ByteBuffer buffer0)
    {
        int j = 0;
        int k = -1;
        for(int l = 0; l < i; l++)
    ...
    public static void method526(String s, boolean flag, ByteBuffer buffer0)
    {
        if(s.length() > 80)
            s = s.substring(0, 80);
        s = s.toLowerCase();
    ...
    public static String method527(String s, int i) {
        aClass30_Sub2_Sub2_632.offset = 0;
        method526(s, aBoolean630, aClass30_Sub2_Sub2_632);
        int j = aClass30_Sub2_Sub2_632.offset;
        aClass30_Sub2_Sub2_632.offset = 0;
        if(i != 0)
    ...
    public static ByteBuffer aClass30_Sub2_Sub2_632 = new ByteBuffer(new byte[100]);
