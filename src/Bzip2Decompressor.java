...
public class Bzip2Decompressor {
    ...
    public static int decompress(byte abyte0[], int i, byte abyte1[], int j, int k) {
        synchronized(currentEntry) {
            currentEntry.aByteArray563 = abyte1;
            currentEntry.anInt564 = k;
            currentEntry.aByteArray568 = abyte0;
            currentEntry.anInt569 = 0;
            currentEntry.anInt565 = j;
            currentEntry.anInt570 = i;
            currentEntry.anInt577 = 0;
            currentEntry.anInt576 = 0;
            currentEntry.anInt566 = 0;
            currentEntry.anInt567 = 0;
            currentEntry.anInt571 = 0;
            currentEntry.anInt572 = 0;
            currentEntry.anInt579 = 0;
            method227(currentEntry);
            i -= currentEntry.anInt570;
            int l = i;
            return l;
        }
    }

    public static void method226(Bzip2Entry class32)
    {
        byte byte4 = class32.aByte573;
        int i = class32.anInt574;
        int j = class32.anInt584;
        int k = class32.anInt582;
        int ai[] = Bzip2Entry.anIntArray587;
...
label0:
    ...
    public static void method227(Bzip2Entry class32)
    {
        boolean flag = false;
        boolean flag1 = false;
        boolean flag2 = false;
        ...
        int ai2[] = null;
        class32.anInt578 = 1;
        if(Bzip2Entry.anIntArray587 == null)
            Bzip2Entry.anIntArray587 = new int[class32.anInt578 * 0x186a0];
        boolean flag19 = true;
        while(flag19) 
        {
            ...
            for(int k5 = ai2[l7 - ai1[i7]]; k5 != l4;)
                if(k5 == 0 || k5 == 1)
                {
                    ...
                    for(; j6 > 0; j6--)
                    {
                        Bzip2Entry.anIntArray587[i6] = byte5 & 0xff;
                        i6++;
                    }
                ...
                } else
                {
                    ...
                    Bzip2Entry.anIntArray587[i6] = class32.aByteArray591[byte6 & 0xff] & 0xff;
                    i6++;
                    if(j5 == 0)
                    {
                        i5++;
            ...
            {
                byte byte7 = (byte)(Bzip2Entry.anIntArray587[l2] & 0xff);
                Bzip2Entry.anIntArray587[class32.anIntArray585[byte7 & 0xff]] |= l2 << 8;
                class32.anIntArray585[byte7 & 0xff]++;
            }

            class32.anInt581 = Bzip2Entry.anIntArray587[class32.anInt580] >> 8;
            class32.anInt584 = 0;
            class32.anInt581 = Bzip2Entry.anIntArray587[class32.anInt581];
    ...
    public static byte method228(Bzip2Entry class32)
    {
        return (byte)method230(8, class32);
    }

    public static byte method229(Bzip2Entry class32)
    {
        return (byte)method230(1, class32);
    }

    public static int method230(int i, Bzip2Entry class32)
    {
        int j;
        do
        {
    ...
    public static void method231(Bzip2Entry class32)
    {
        class32.anInt588 = 0;
        for(int i = 0; i < 256; i++)
    ...
    public static Bzip2Entry currentEntry = new Bzip2Entry();
