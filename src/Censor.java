...
public class Censor {
    ...
    public static void unpackCensor(ArchivePackage class44) {
        ByteBuffer buffer0 = new ByteBuffer(class44.getArchive("fragmentsenc.txt", null));
        ByteBuffer buffer1 = new ByteBuffer(class44.getArchive("badenc.txt", null));
        ByteBuffer buffer2 = new ByteBuffer(class44.getArchive("domainenc.txt", null));
        ByteBuffer buffer3 = new ByteBuffer(class44.getArchive("tldlist.txt", null));
        loadCensor(buffer0, buffer1, buffer2, buffer3);
    }

    public static void loadCensor(ByteBuffer buffer0, ByteBuffer buffer1, ByteBuffer buffer2, ByteBuffer buffer3) {
    ...
    public static void loadTldlist(byte junk, ByteBuffer buffer0) {
        int i = buffer0.getDword();
    ...
    public static void loadBadenc(int junk, ByteBuffer buffer0)
    {
        int j = buffer0.getDword();
    ...
    public static void loadDomainenc(ByteBuffer buffer0, byte junk)
    {
        int i = buffer0.getDword();
    ...
    public static void loadFrangmentsenc(ByteBuffer buffer0, boolean junk)
    {
        anIntArray620 = new int[buffer0.getDword()];
        for(int i = 0; i < anIntArray620.length; i++)
            anIntArray620[i] = buffer0.getUword();
    }

    public static void method493(ByteBuffer buffer0, char ac[][], boolean flag, byte abyte0[][][])
    {
        if(!flag)
        {
            for(int i = 1; i > 0; i++);
    ...
    public static void method494(char ac[][], ByteBuffer buffer0, int i)
    {
        if(i >= 0)
            return;
        for(int j = 0; j < ac.length; j++)
