...
public class Sound {
    ...
    public static void method240(int i, ByteBuffer buffer0) {
        aByteArray327 = new byte[0x6baa8];
        aClass30_Sub2_Sub2_328 = new ByteBuffer(aByteArray327);
        if(i != 0)
    ...
    public static ByteBuffer method241(int i, int j, boolean flag)
    {
        if(flag)
    ...
    public void method242(boolean flag, ByteBuffer buffer0)
    {
        for(int i = 0; i < 10; i++)
        {
        ...
        if(!flag)
            anInt324 = 58;
        anInt330 = buffer0.getUword();
        anInt331 = buffer0.getUword();
    }
    ...
    public ByteBuffer method244(int i, int j)
    {
        int k = method245(i);
        aClass30_Sub2_Sub2_328.offset = 0;
        aClass30_Sub2_Sub2_328.putDword(0x52494646);
        aClass30_Sub2_Sub2_328.putDwordLE(36 + k);
        aClass30_Sub2_Sub2_328.putDword(0x57415645);
        aClass30_Sub2_Sub2_328.putDword(0x666d7420);
        aClass30_Sub2_Sub2_328.putDwordLE(16);
        aClass30_Sub2_Sub2_328.putWordLE(1);
        if(j < 6 || j > 6)
        {
            for(int l = 1; l > 0; l++);
        }
        aClass30_Sub2_Sub2_328.putWordLE(1);
        aClass30_Sub2_Sub2_328.putDwordLE(22050);
        aClass30_Sub2_Sub2_328.putDwordLE(22050);
        aClass30_Sub2_Sub2_328.putWordLE(1);
        aClass30_Sub2_Sub2_328.putWordLE(8);
        aClass30_Sub2_Sub2_328.putDword(0x64617461);
        aClass30_Sub2_Sub2_328.putDwordLE(k);
        aClass30_Sub2_Sub2_328.offset += k;
    ...
    public static ByteBuffer aClass30_Sub2_Sub2_328;
